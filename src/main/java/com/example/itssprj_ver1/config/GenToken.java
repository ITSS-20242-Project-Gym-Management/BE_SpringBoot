...
public class GenToken {
    private static final String SECRET_KEY = "ITSSBE-HKHAK"; // Khóa bí mật cho chữ ký
    private static final long EXPIRATION_TIME = 604800000L; // Thời gian hết hạn (7 ngày)

    // Hàm tạo JWT token với username và password
    public static String generateToken(String username, String password) {
        try {
            ...
            String payloadJson = String.format("{\"sub\":\"%s\",\"passwordHash\":\"%s\",\"exp\":%d}", username, passwordHash, expiration);
